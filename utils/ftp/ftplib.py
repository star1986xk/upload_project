...
class FTP:
    ...
    def ntransfercmd(self, cmd, rest=None, ip=None):
    ...
    def transfercmd(self, cmd, rest=None, ip=None):
        """Like ntransfercmd() but returns only the socket."""
        return self.ntransfercmd(cmd, rest, ip=ip)[0]
    ...
    def storbinary(self, cmd, fp, blocksize=8192, callback=None, rest=None, ip=None):
        ...
        """
        self.voidcmd('TYPE I')
        with self.transfercmd(cmd, rest, ip=ip) as conn:
            while 1:
